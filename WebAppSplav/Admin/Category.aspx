<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="WebAppSplav.Admin.Category" %>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6 col-md-4 col-lg-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:CheckBox ID="cbIsActive" runat="server" Text="&nbsp Выполняется"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <asp:LinkButton ID="lnkDelete" Text="Delete" runat="server" CommandName="delete"
                                                                                ...
                                                                                OnClientClick="return confirm('Уверены что хотите удалить?');">
                                                                               <i class="ti-trash"></i>
                                                                            </asp:LinkButton>
